...
import HorizontalCards from "../components/partials/Horizontal";
...
const PersonDetails = () => {
    ...
    return info ? (
        ...
        <div className="px-[10%] w-screen h-auto bg-[#1F1E24] ">
            ...
            <div className="w-full flex bg-[#1F1E24] ">
                ...
                <div className="w-[80%] ml-[5%] bg-[#1F1E24]">
                    ...
                    <div className="list-disc text-zinc-400 w-full  mt-5 overflow-x-hidden overflow-y-auto shadow-xl shadow-[rgba(255,255,255,.3)] border-2 border-zinc-700 p-5 bg-[#1F1E24]">
